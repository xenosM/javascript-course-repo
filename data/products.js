...
class Appliances extends Product{
  ...
  extraInfoHtml(){
    return`
    <a href="${this.instructionLink}" target="_blank">Show instruction</a>
    <a href="${this.warrentyLink}" target="_blank">Show warrenty</a>
    `
...
export function loadProducts(func){
  ...
  xhr.addEventListener('load',()=>{
    products = JSON.parse(xhr.response).map((productDetails)=>{
      ...
      else if(productDetails.type === 'appliance') return new Appliances(productDetails); 
